---
title: "2. Seagrass Restoration Trade-offs Paper - Using PrioritizR to identify potential areas for conservation that optimizes multiple ecosystem service outcomes (5% represenation)"
...
write.csv(Solution_Eval_Metrics_Confrimed_Beds,file = "publication_plots/Results_10_18_2023/Solution_Evaluation_Metrics_Confirmed_Beds_5Percent.csv") 
...
tiff(filename = "publication_plots/Results_10_18_2023/Fig_5perc_solutions_ConfirmedBeds.tif",width = 7.5,height = 4,units = "in",res = 300)
p1 + p2 & theme_classic() & theme(legend.position = "none") & plot_annotation(title = "Confirmed Beds (5% representation)")
dev.off()
