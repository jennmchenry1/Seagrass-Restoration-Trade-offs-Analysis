...
# BioDiv_EV_Confirmed=rast("input_data/ES-Model-Outputs/ConfirmedBeds/BioDiv_EV_Zscores_Confirmed.tif")
# NurHab_EV_Confirmed=rast("input_data/ES-Model-Outputs/ConfirmedBeds/NursHab_EV_Zscores_Confirmed.tif")
# BlueCar_EV_Confirmed=rast("input_data/ES-Model-Outputs/ConfirmedBeds/BC_Storage_EV_Zscores_Confirmed.tif")
# RecTour_EV_Confirmed=rast("input_data/ES-Model-Outputs/ConfirmedBeds/Rec_EV_Zscores_Confirmed.tif")
# Expos_EV_Confirmed=rast("input_data/ES-Model-Outputs/ConfirmedBeds/Exposure_EV_Zscores_Confirmed.tif")
# 
# ES_Zscores=c(BioDiv_EV_Confirmed,NurHab_EV_Confirmed,BlueCar_EV_Confirmed,RecTour_EV_Confirmed,Expos_EV_Confirmed)
# 
# ES_Zscores_Confirmed=mask(ES_Zscores,mask=Confirmed)
# ES_Zscores_Confirmed <- terra::project(x=ES_Zscores_Confirmed, y=newproj)
# # ES_Zscores_Confirmed <- terra::project(x=ES_Zscores_Confirmed, res=100,y=newproj)
# 
# # Potential Recovery Areas
# #Loading ES Outputs (Standarized)
# BioDiv_EV_PRAs=rast("input_data/ES-Model-Outputs/PRAs/BioDiv_EV_Zscores_PRAs.tif")
# NurHab_EV_PRAs=rast("input_data/ES-Model-Outputs/PRAs/NursHab_EV_Zscores_PRAs.tif")
# BlueCar_EV_PRAs=rast("input_data/ES-Model-Outputs/PRAs/BC_Storage_EV_Zscores_PRAs.tif")
# RecTour_EV_PRAs=rast("input_data/ES-Model-Outputs/PRAs/Rec_EV_Zscores_PRAs.tif")
# Expos_EV_PRAs=rast("input_data/ES-Model-Outputs/PRAs/Exposure_EV_Zscores_PRAs.tif")
# Pop_EV_PRAs=rast("input_data/ES-Model-Outputs/PRAs/Population_EV_Zscores_PRAs.tif")
# 
# ES_Zscores_PRAs=c(BioDiv_EV_PRAs,NurHab_EV_PRAs,BlueCar_EV_PRAs,RecTour_EV_PRAs,Expos_EV_PRAs)
# ES_Zscores_PRAs=mask(ES_Zscores_PRAs,mask=PRAs)
# ES_Zscores_PRAs <- terra::project(x=ES_Zscores_PRAs, y=newproj)
# # ES_Zscores_PRAs <- terra::project(x=ES_Zscores_PRAs, res=100,y=newproj)
```
...
# ES_Confirmed_1HA<-resample(x= ES_Zscores_Confirmed, y=Total_Predicted_Seagrass_1HA)
# 
# ES_Zscores_Confirmed_1HA_df=as.points(ES_Zscores_Confirmed_1HA)
# names(ES_Zscores_Confirmed_1HA_df)<-c("BioDiv","NurHab","BlueCar","RecTour","Expos")
# summary(ES_Zscores_Confirmed_1HA_df)
# 
# ES_Zscores_PRAs_1HA<-resample(x= ES_Zscores_PRAs, y=Total_Predicted_Seagrass_1HA)
# 
# ES_Zscores_PRAs_1HA_df=as.points(ES_Zscores_PRAs_1HA)
# names(ES_Zscores_PRAs_1HA_df)<-c("BioDiv_PRAs","NurHab_PRAs","BlueCar_PRAs","RecTour_PRAs","Expos_PRAs")
# summary(ES_Zscores_PRAs_1HA_df)
# 
# 
# # 1-kilometer analysis stack
# ES_Zscores_Confirmed_1KM<-resample(x=ES_Zscores_Confirmed, y=Total_Predicted_Seagrass_1KM)
# 
# ES_Zscores_Confirmed_1KM_df=as.points(ES_Zscores_Confirmed_1KM)
# names(ES_Zscores_Confirmed_1KM_df)<-c("BioDiv","NurHab","BlueCar","RecTour","Expos")
# summary(ES_Zscores_Confirmed_1KM_df)
# 
# ES_Zscores_PRAs_1KM<-resample(x= ES_Zscores_PRAs, y=Total_Predicted_Seagrass_1KM)
# 
# ES_Zscores_PRAs_1KM_df=as.points(ES_Zscores_PRAs_1KM)
# names(ES_Zscores_PRAs_1KM_df)<-c("BioDiv_PRAs","NurHab_PRAs","BlueCar_PRAs","RecTour_PRAs","Expos_PRAs")
# summary(ES_Zscores_PRAs_1KM_df)
# 
# # 5-kilometer analysis stack
# ES_Zscores_Confirmed_5KM<-resample(x= ES_Zscores_Confirmed, y=Total_Predicted_Seagrass_5KM)
# 
# ES_Zscores_Confirmed_5KM_df=as.points(ES_Zscores_Confirmed_5KM)
# names(ES_Zscores_Confirmed_5KM_df)<-c("BioDiv","NurHab","BlueCar","RecTour","Expos")
# summary(ES_Zscores_Confirmed_5KM_df)
# 
# ES_Zscores_PRAs_5KM<-resample(x= ES_Zscores_PRAs, y=Total_Predicted_Seagrass_5KM)
# 
# ES_Zscores_PRAs_5KM_df=as.points(ES_Zscores_PRAs_5KM)
# names(ES_Zscores_PRAs_5KM_df)<-c("BioDiv_PRAs","NurHab_PRAs","BlueCar_PRAs","RecTour_PRAs","Expos_PRAs")
# summary(ES_Zscores_PRAs_5KM_df)
# 
# # 10-kilometer analysis stack
# ES_Zscores_Confirmed_10KM<-resample(x= ES_Zscores_Confirmed, y=Total_Predicted_Seagrass_10KM)
# 
# ES_Zscores_Confirmed_10KM_df=as.points(ES_Zscores_Confirmed_10KM)
# names(ES_Zscores_Confirmed_10KM_df)<-c("BioDiv","NurHab","BlueCar","RecTour","Expos")
# summary(ES_Zscores_Confirmed_10KM_df)
# 
# ES_Zscores_PRAs_10KM<-resample(x=ES_Zscores_PRAs, y=Total_Predicted_Seagrass_10KM)
# 
# ES_Zscores_PRAs_10KM_df=as.points(ES_Zscores_PRAs_10KM)
# names(ES_Zscores_PRAs_10KM_df)<-c("BioDiv_PRAs","NurHab_PRAs","BlueCar_PRAs","RecTour_PRAs","Expos_PRAs")
