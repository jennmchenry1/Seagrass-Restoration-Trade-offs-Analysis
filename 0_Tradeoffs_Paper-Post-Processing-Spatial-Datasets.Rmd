...
# Saving output
```{r}
rm(list= ls()[!(ls() %in% c("Total_Predicted_Seagrass","PRAs","Confirmed","Total_Predicted_Seagrass_1HA_WGS","Total_Predicted_Seagrass_1KM_WGS","ES_Zscores_PRAs_1HA","ES_Zscores_PRAs_1HA_df","ES_Zscores_Confirmed_1HA","ES_Zscores_Confirmed_1HA_df","ES_Zscores_PRAs_1KM","ES_Zscores_PRAs_1KM_df","ES_Zscores_Confirmed_1KM","ES_Zscores_Confirmed_1KM_df"))])
