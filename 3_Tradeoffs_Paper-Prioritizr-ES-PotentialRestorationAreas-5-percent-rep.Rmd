---
title: "2. Seagrass Restoration Trade-offs Paper - Using PrioritizR to identify potential areas for restoration that optimizes multiple ecosystem service outcomes (5% representation)"
...
Single_Service <- function(area,features,targets){
  ...
  N_ES_evaluation_output$Target <- c("0.05")
...
write.csv(Solution_Eval_Metrics_PRAs,file = "publication_plots/Results_10_18_2023/Solution_Evaluation_Metrics_Restoration_5Percent.csv") 
...
tiff(filename = "publication_plots/Results_10_18_2023/Fig_5perc_solutions_PRAs.tif",width = 7.5,height = 4,units = "in",res = 300)
p1 + p2 & theme_classic() & theme(legend.position = "none") & plot_annotation(title = "Restoration Areas (5% representation)")
dev.off()
